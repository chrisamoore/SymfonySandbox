Vagrant.configure("2") do |config|
  ...
  # config.vm.synced_folder "./", "/var/www", :mount_options => ['dmode=777','fmode=777'], :nfs => false
  config.vm.synced_folder "./", "/usr/share/nginx/www/html", id: "vagrant-root", :nfs => true
  #config.vm.synced_folder "./", "/usr/share/nginx/www/html", id: "vagrant-root", :nfs => {
  # :mount_options   => ['dmode=777,fmode=777']
  #}

  # config.vm.usable_port_range = (2200..2200)
